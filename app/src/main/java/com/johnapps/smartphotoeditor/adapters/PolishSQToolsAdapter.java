    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            ...
            this.relative_layout_wrapper_tool.setOnClickListener(view1 ->
                    PolishSQToolsAdapter.this.onQuShotSplashItemSelected.onQuShotSQToolSelected((PolishSQToolsAdapter.this.toolModelArrayList.get(ViewHolder.this.getLayoutPosition())).toolType));
        }
    }
}

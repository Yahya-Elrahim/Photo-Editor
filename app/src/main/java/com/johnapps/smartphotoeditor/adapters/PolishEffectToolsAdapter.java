    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            ...
            this.relative_layout_wrapper_tool.setOnClickListener(view1 ->
                    PolishEffectToolsAdapter.this.onQuShotEffectItemSelected.onQuShotEffectToolSelected((PolishEffectToolsAdapter.this.toolModelArrayList.get(ViewHolder.this.getLayoutPosition())).toolType));
        }
    }
}

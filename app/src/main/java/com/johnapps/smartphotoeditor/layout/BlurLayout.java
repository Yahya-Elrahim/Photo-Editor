...
import com.johnapps.smartphotoeditor.PolishBlurView;
import com.johnapps.smartphotoeditor.draw.BlurBrushView;
...
public class BlurLayout extends PolishBaseActivity implements OnSeekBarChangeListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        findViewById(R.id.relativeLayoutBlur).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                erase = false;
                blurView.mode = 0;
                PolishBlurView touchImageView3 = blurView;
        ...
        findViewById(R.id.imageViewFit).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                PolishBlurView touchImageView2 = blurView;

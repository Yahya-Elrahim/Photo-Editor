...
import com.johnapps.smartphotoeditor.BuildConfig;
...
import com.johnapps.smartphotoeditor.adapters.TetxColorAdapter;
import com.johnapps.smartphotoeditor.draw.SplashBrushView;
import com.johnapps.smartphotoeditor.PolishSplashView;
import com.johnapps.smartphotoeditor.support.MyExceptionHandlerPix;
import com.johnapps.smartphotoeditor.support.SupportedClass;
...
public class SplashLayout extends PolishBaseActivity implements OnSeekBarChangeListener,
        TetxColorAdapter.ColorListener{
    ...
    public void onCreate(Bundle bundle) {
        ...
        findViewById(R.id.relativeLayoutManual).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                ...
                tetxColorAdapter = (TetxColorAdapter) recyclerViewColor.getAdapter();

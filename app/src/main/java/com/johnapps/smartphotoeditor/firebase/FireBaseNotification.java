package com.johnapps.smartphotoeditor.firebase;
...
import com.johnapps.smartphotoeditor.activities.PolishHomeActivity;
...
public class FireBaseNotification extends FirebaseMessagingService {
    ...
    private void sendNotification(String title, String messageBody) {
        Intent intent = new Intent(this, PolishHomeActivity.class);

...
import com.johnapps.smartphotoeditor.utils.StickerUtils;
...
public class PolishStickerView extends RelativeLayout {
    ...
    public void getStickerIcons() {
        PolishStickerIcons quShotStickerIconClose = new PolishStickerIcons(ContextCompat.getDrawable(getContext(), R.drawable.ic_outline_close), 0, PolishStickerIcons.DELETE);
        quShotStickerIconClose.setIconEvent(new DeleteIconEvent());
        PolishStickerIcons quShotStickerIconScale = new PolishStickerIcons(ContextCompat.getDrawable(getContext(), R.drawable.ic_outline_scale), 3, PolishStickerIcons.SCALE);
                ...
                while (i < this.icons.size()) {
                    ...
                    switch (bitmapStickerIcon.getPosition()) {
                        case 0:
                            ...
                            break;
                        case 1:
                            if (((this.handlingSticker instanceof PolishTextView) && bitmapStickerIcon.getTag().equals(PolishStickerIcons.EDIT)) || ((this.handlingSticker instanceof DrawableSticker) && bitmapStickerIcon.getTag().equals(PolishStickerIcons.FLIP))) {
                                configIconMatrix(bitmapStickerIcon, f7, f8, calculateRotation);
                                bitmapStickerIcon.draw(canvas2, this.borderPaint);
                                break;
                            }
                        case 2:
                            if (this.handlingSticker instanceof PolishSticker) {
                                if (((PolishSticker) this.handlingSticker).getType() != 0) {
                                    break;
                                } else {
                        ...
                        case 3:
                            if ((!(this.handlingSticker instanceof PolishTextView) || !bitmapStickerIcon.getTag().equals(PolishStickerIcons.ROTATE)) && (!(this.handlingSticker instanceof DrawableSticker) || !bitmapStickerIcon.getTag().equals(PolishStickerIcons.SCALE))) {
                                if (this.handlingSticker instanceof PolishSticker) {
                                    PolishSticker beautySticker = (PolishSticker) this.handlingSticker;
    ...
    public void configIconMatrix(@NonNull PolishStickerIcons bitmapStickerIcon, float f, float f2, float f3) {
    ...
    public boolean replace(@Nullable Sticker sticker, boolean z) {
        ...
        if (z) {
            ...
            } else if (this.handlingSticker instanceof PolishTextView) {
    ...
    @NonNull
    public PolishStickerView addSticker(@NonNull Sticker sticker) {
        return addSticker(sticker, 1);
    }

    public PolishStickerView addSticker(@NonNull final Sticker sticker, final int i) {
    ...
    @NonNull
    public PolishStickerView setOnStickerOperationListener(@Nullable OnStickerOperationListener onStickerOperationListener2) {
    ...
    public void setIcons(@NonNull List<PolishStickerIcons> list) {
        this.icons.clear();
